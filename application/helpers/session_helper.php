...
if (! function_exists('session_get_superadmin')) {

	function session_get_superadmin()
	{
		$ss = _initialize_session_service();
		return $ss->get_superadmin();
	}
}

if (! function_exists('session_get_admingroup')) {

	function session_get_admingroup()
	{
		$ss = _initialize_session_service();
		return $ss->get_admingroup();
	}
}

if (! function_exists('session_get_employee')) {

	function session_get_employee()
	{
		$ss = _initialize_session_service();
		return $ss->get_employee();
	}
}

if (! function_exists('session_get_owner')) {

    function session_get_owner()
    {
        $ss = _initialize_session_service();
        return $ss->get_owner();
    }
